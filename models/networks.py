...
#from spectral_normalization import SpectralNorms
import torchvision
import math
...
class resnet_block(nn.Module):
    def __init__(self, channel, kernel, stride, padding):
        ...
        self.conv1 = Inception(channel, int(channel/4), (channel, int(channel/4)), (32, int(channel/4)),int(channel/4))
        self.conv1_norm = nn.InstanceNorm2d(channel)
        self.conv2 = Inception(channel, int(channel/4), (channel, int(channel/4)), (32, int(channel/4)),int(channel/4))

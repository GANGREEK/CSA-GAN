...
class AttentionGANModel(BaseModel):
 ...
 #################RALSGAN###############################
    ...
    def backward_G(self):
        ...
        self.loss_CSA = self.criterionCS(self.fake_A,self.rec_A)*k#lambda_CS_A
        self.loss_CSB = self.criterionCS(self.fake_B,self.rec_B)*k#lambda_CS_A
        self.loss_CS_A = self.criterionCS(self.fake_A,self.real_A)*k#lambda_CS_A
        self.loss_CS_B = self.criterionCS(self.fake_B,self.real_B)*k#lambda_CS_A
        self.loss_CS_A1 = self.criterionCS(self.rec_A,self.real_A)*k#lambda_CS_A
        self.loss_CS_B1 = self.criterionCS(self.rec_B,self.real_B)*k#lambda_CS_A
...
######################################################################################################################################################
        ...
        self.syn_loss =  self.loss_SynB + self.loss_SynA + self.loss_CS_A+ self.loss_CS_B + self.loss_CSA +  self.loss_CSB +self.loss_CS_A1 +self.loss_CS_B1 + self.feat_loss2
        ...
        self.loss_G = self.loss_G_A + self.loss_G_B  + self.loss_cycle_A + self.loss_cycle_B  + self.syn_loss # 

...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--which_model_feat', type=str, default='resnet34', help='selects model to use for feature network')
        # dataset paramete
       ...
       ######################################
        ...
        parser.add_argument('--fineSize', type=int, default=256, help='output size')
...
#####
        ...
        parser.add_argument('--use_avgpool', type=float, default=0, help='use perceptrual loss')
#####################################Options#################################################
